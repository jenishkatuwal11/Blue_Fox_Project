...
const FindRoom = () => {
  ...
  const properties = [
    {
      ...
      price: "Rs 15,000,000",
      description:
        "A luxurious and modern house located in Kathmandu, offering a serene environment with all modern amenities. Ideal for family living with close proximity to schools and shopping centers.",
      type: "House",
      bedrooms: 5,
      bathrooms: 4,
      area: "4000 sq ft",
    },
    {
      ...
      description:
        "A fully furnished, cozy room located in the heart of Bhaktapur. Perfect for singles or students, with access to local heritage sites and vibrant street life.",
      type: "Room",
      bedrooms: 1,
      bathrooms: 1,
      area: "600 sq ft",
    },
    {
      ...
      price: "Rs 35,000,000",
      description:
        "A spacious and elegant apartment located in Patan, offering a perfect blend of modern living and historical charm. Ideal for families looking for comfort in a prime location.",
      type: "Apartment",
      bedrooms: 3,
      bathrooms: 3,
      area: "2800 sq ft",
    },
    {
      ...
      price: "Rs 20,000,000",
      description:
        "A beautiful and spacious house located in Bhaktapur with traditional architecture and modern facilities. Perfect for family living in a calm neighborhood.",
      type: "House",
      bedrooms: 4,
      bathrooms: 3,
      area: "3500 sq ft",
...

    {
      ...
      price: "Rs 22,000,000",
      description:
        "A large family home in the suburbs of Kathmandu with a garden and terrace. Ideal for families looking for space and comfort in a residential area.",
      type: "House",
      bedrooms: 5,
      bathrooms: 4,
      area: "4000 sq ft",
...

    {
      ...
      description:
        "A cozy and affordable room in a shared apartment in Bhaktapur. Ideal for students or young professionals.",
      type: "Room",
      bedrooms: 1,
      bathrooms: 1,
      area: "500 sq ft",
...

    {
      ...
      description:
        "A fully furnished room located in the heart of Kathmandu. Perfect for those looking for a convenient and comfortable living arrangement.",
      type: "Room",
      bedrooms: 1,
      bathrooms: 1,
      area: "650 sq ft",
...

    {
      ...
      price: "Rs 28,000,000",
      description:
        "A newly built modern apartment in Bhaktapur with top-of-the-line amenities. Ideal for families looking for contemporary living.",
      type: "Apartment",
      bedrooms: 3,
      bathrooms: 3,
      area: "2800 sq ft",
...

    {
      ...
      price: "Rs 50,000,000",
      description:
        "A luxurious apartment in Kathmandu with breathtaking views of the city. Offering state-of-the-art facilities for upscale living.",
      type: "Apartment",
      bedrooms: 4,
      bathrooms: 4,
      area: "3500 sq ft",
  ...
  const handlePreviousImage = (index) => {
    setCurrentImageIndex((prevIndexes) =>
      prevIndexes.map((imgIndex, i) =>
        i === index
          ? (imgIndex - 1 + properties[i].images.length) %
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-600 lg:mx-auto">
              Discover top-notch real estate options in Nepal’s iconic cities,
              offering the perfect blend of modern living and rich heritage.
            </p>
          </div>
            ...
            {properties.map((property, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-black-500 text-lg font-bold mt-2">
                    {property.price}
                  </p>
